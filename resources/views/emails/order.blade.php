                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    <h1 style="font-size:24px;margin:0 0 20px 0;font-family:Arial,sans-serif;">
                                        Welcome Dear {{$mailData->user->name}} </h1>
                                    <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                        <h1>Congratulations!</h1>

                                        You have successfully created an account on our website, and as a token of our appreciation, we are pleased to inform you that you will receive a complimentary order at no cost.

                                        Enjoy your experience with us!
                                    </p>
                                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><a
                                            href="https://www.facebook.com/M0o0hamedAhmed/"
                                            style="color:#ee4c50;text-decoration:underline;">I will surprise you  </a>
                                        You Number is : {{$mailData->user->name}}  and you working in <a  style="color:#ee4c50;text-decoration:underline;" href="https://www.linkedin.com/company/thecodetime/">the code time </a>
                                    </p>
                                </td>
                            </tr>
